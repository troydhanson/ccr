...
#define CCR_KEEPEXIST (1U << 6)
#define CCR_OVERWRITE (1U << 7)
#define CCR_CASTFILE  (1U << 8)
#define CCR_CASTCOPY  (1U << 9)
#define CCR_CASTTEXT  (1U << 10)
#define CCR_JSON      (1U << 11)
#define CCR_PRETTY    (1U << 12)
#define CCR_NEWLINE   (1U << 13)
#define CCR_LEN4FIRST (1U << 14)
